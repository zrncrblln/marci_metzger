import { Star, FileText, Repeat, Lightbulb, Paintbrush, MapPin } from "lucide-react";
      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-14">
          ...
          <h2 className="section-heading mb-4">
            The essence of extraordinary<br />living lies in the Little things.
          </h2>
          <p className="section-subheading">Explore what makes each Cetfar home unique.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-background rounded-2xl p-6 border border-border">
            ...
            <h3 className="font-heading text-lg mb-2">Exceptional Craftsmanship</h3>
            <p className="text-sm text-muted-foreground">Meticulously crafted with top-tier materials for unmatched quality.</p>
          </div>
          <div className="bg-background rounded-2xl overflow-hidden border border-border">
            ...
            <img src={smoothJourney} alt="Smooth Journey" className="w-full h-48 object-cover" />
          </div>
          <div className="bg-background rounded-2xl p-6 border border-border">
            <Repeat size={24} className="text-foreground mb-3" />
            <h3 className="font-heading text-lg mb-2">Adaptable Design</h3>
            <p className="text-sm text-muted-foreground">Our designs adapt to your needs for lasting functionality.</p>
          </div>
          ...
          <div className="bg-background rounded-2xl overflow-hidden border border-border">
            ...
            <img src={innovative} alt="Innovative Living" className="w-full h-48 object-cover" />
          </div>
          <div className="bg-background rounded-2xl p-6 border border-border">
            <Paintbrush size={24} className="text-foreground mb-3" />
            <h3 className="font-heading text-lg mb-2">Custom Design</h3>
            <p className="text-sm text-muted-foreground">From start to finish, we ensure a seamless process dedicated to realizing your vision.</p>
          </div>
          <div className="bg-background rounded-2xl overflow-hidden border border-border">
            <img src={custom} alt="Custom Design" className="w-full h-full object-cover min-h-[200px]" />
          </div>
